...
namespace PO_CustomEnergyWeapons{
	...
	public static class BlocksConfig{
		...
		public static WeaponConfig GetWeaponConfig(string subtypeName){
			...
			if(subtypeName == "HeavyFixedLaser"){
				
				//Do Not Edit This Line
				var Settings = new WeaponConfig();
				
				//Weapon Subtype
				Settings.WeaponSubtypeId = "HeavyFixedLaser"; //Change this to the same weapon subtype as used above in the script setup
				...
				Settings.AmmoRegenerationMaxPowerDraw = 25; //Maximum amount of power the weapon should draw to generate ammo.
				Settings.AmmoRegenerationMedPowerDraw = 25; //If Maximum amount of power draw is unavailable, then this amount is drawn instead.
				Settings.AmmoRegenerationTime = 25; //Time until ammo is generated (at rate of 1MW per second).
				...
				//Distance Settings
				Settings.WeaponDistance = 2500; //Beam Distance
			...
			//Upgrade Valid Names
				...
				*/
				...
				Settings.BaseDamageAmount = 60; //Damage amount per step (steps defined by DamageTimerLimit setting above)
				...
				Settings.BeamMinimumRadius = 2.1f; //Minimum Random Beam Radius if UseBeamFlicker is true
				Settings.BeamMaximumRadius = 2.5f; //Maximum Random Beam Radius if UseBeamFlicker is true
				Settings.BeamColors.Add(Color.Blue);   //The color of the bolt. Copy this line to use other colors in the bolt.
			...
			if(subtypeName == "LightFixedLaser"){
				
				//Do Not Edit This Line
				var Settings = new WeaponConfig();
				
				//Weapon Subtype
				Settings.WeaponSubtypeId = "LightFixedLaser"; //Change this to the same weapon subtype as used above in the script setup
				Settings.UseScriptedFire = true; //Change this to false if you only want to use the ammo generating feature of the weapon.
				//Incomplete Feature: Settings.RegisterDamageHandlerForTracers = false; //Set to true if you plan to use non-beam vanilla tracers with this weapon.
				...
				Settings.UseRegenerativeAmmo = true; //If set to 'true', then this weapon will consume grid energy and generate ammo automatically.
				Settings.AmmoMagazineSubtypeId = "PDLaserCharge"; //The AmmoMagazine SubtypeId this weapon uses.
				Settings.AmmoRegenerationMaxPowerDraw = 15; //Maximum amount of power the weapon should draw to generate ammo.
				Settings.AmmoRegenerationMedPowerDraw = 15; //If Maximum amount of power draw is unavailable, then this amount is drawn instead.
				Settings.AmmoRegenerationTime = 15; //Time until ammo is generated (at rate of 1MW per second).
				Settings.AmmoAmountToAdd = 20; //Number of ammo magazines added when a charge is complete.
				Settings.MaxAmmoInInventory = 20; //If ammo in weapon meets or exceeds this number, ammo regeneration will stop.
				Settings.AmmoRegenerationFreeForNPC = true; //If true and the block is owned by a valid NPC identity, the weapon will not draw energy to generate ammo, but will still create the ammo as if charging at AmmoRegenerationMaxPowerDraw rate.
				Settings.MustBeWorkingAtMaxDraw = false; //If true, weapon must be on, undamaged, and charging at max. If any of the consitions are not met, charge is reset to 0 and ammo is removed.
			...
			Settings.EmissiveChargingName = "Emissive"; //Emissive Material Name
			Settings.EmissiveChargingAmount = 1; //Emissive Amount - can be between 0-1 (non integers should be formatted with 'f' at the end. eg: 0.5f)
			Settings.EmissiveChargingColor = new Color(0,255,0,255); //RGBA value of Emissive
			...
			Settings.EmissiveFiringName = "Emissive"; //Emissive Material Name
			Settings.EmissiveFiringAmount = 1; //Emissive Amount - can be between 0-1 (non integers should be formatted with 'f' at the end. eg: 0.5f)
			Settings.EmissiveFiringColor = new Color(0,255,0,175); //RGBA value of Emissive when Firing
			Settings.EmissiveFiringOffColor = new Color(0,255,0,175); //RGBA value of Emissive when Not Firing
			
			//Multibeam Settings
			Settings.BarrelSubpartOffsets.Add(new Vector3D(0,0,-1f)); //Copy This Line and Provide the XYZ offset of any additional barrels that will fire beams on your weapons. Default offset of 0,0,0 can be changed if needed.
			...
			//Upgrade Valid Names
				...
				*/
				...
				//Base Damage
				Settings.UseBaseDamage = true; //Specifies if beam should deal regular damage.
				Settings.BaseDamageAmount = 25; //Damage amount per step (steps defined by DamageTimerLimit setting above)
				Settings.UsePenetrativeDamage = false; //If true, the beam will damage multiple blocks within a grid per step.
				Settings.PenetrativeDistance = 5; //Distance the penetrative damage can reach if enabled.
				Settings.RelaxedMissileIntercept = true; //If true, shots fired at lasers that come close to hitting will still register as a hit.
				...
				//Sound Settings
				Settings.FiringSoundId = "LightLaserFire"; //You can specify an AudioDefinition subtype ID that will play when the weapon is fired.
				
				//Beam Effect
				Settings.UseRegularBeam = true; //if true, a straight laser beam will be drawn from the weapon barrel, 
				Settings.UseBeamFlicker = false; //If true, the beam will not use BeamRadius, but rather random values between BeamMinimumRadius and BeamMaximumRadius
				Settings.BeamRadius = 0.2f; //The beam radius if UseBeamFlicker is false
				Settings.BeamMinimumRadius = 2.1f; //Minimum Random Beam Radius if UseBeamFlicker is true
				Settings.BeamMaximumRadius = 2.5f; //Maximum Random Beam Radius if UseBeamFlicker is true
				Settings.BeamColors.Add(Color.Green);   //The color of the bolt. Copy this line to use other colors in the bolt.
				Settings.FadeThroughColors = false; //If true, beam color will not be randomized. The color will fade from one color to the next in the list you provide (requires at least 2 colors to use)
			...
			//Add Your Block SubtypeId below
			if(subtypeName == "PDLaser"){
				
				//Do Not Edit This Line
				var Settings = new WeaponConfig();
				
				//Weapon Subtype
				Settings.WeaponSubtypeId = "PDLaser"; //Change this to the same weapon subtype as used above in the script setup
				Settings.UseScriptedFire = true; //Change this to false if you only want to use the ammo generating feature of the weapon.
				//Incomplete Feature: Settings.RegisterDamageHandlerForTracers = false; //Set to true if you plan to use non-beam vanilla tracers with this weapon.
				...
				Settings.UseRegenerativeAmmo = true; //If set to 'true', then this weapon will consume grid energy and generate ammo automatically.
				Settings.AmmoMagazineSubtypeId = "PDLaserCharge"; //The AmmoMagazine SubtypeId this weapon uses.
				Settings.AmmoRegenerationMaxPowerDraw = 1; //Maximum amount of power the weapon should draw to generate ammo.
				Settings.AmmoRegenerationMedPowerDraw = 1; //If Maximum amount of power draw is unavailable, then this amount is drawn instead.
				Settings.AmmoRegenerationTime = 1; //Time until ammo is generated (at rate of 1MW per second).
				Settings.AmmoAmountToAdd = 20; //Number of ammo magazines added when a charge is complete.
				Settings.MaxAmmoInInventory = 20; //If ammo in weapon meets or exceeds this number, ammo regeneration will stop.
				Settings.AmmoRegenerationFreeForNPC = true; //If true and the block is owned by a valid NPC identity, the weapon will not draw energy to generate ammo, but will still create the ammo as if charging at AmmoRegenerationMaxPowerDraw rate.
				Settings.MustBeWorkingAtMaxDraw = false; //If true, weapon must be on, undamaged, and charging at max. If any of the consitions are not met, charge is reset to 0 and ammo is removed.
				...
				//Distance Settings
				Settings.WeaponDistance = 500; //Beam Distance
				Settings.SafeRange = 2; //If Beam Hits Own Grid, If Distance From Barrel to Hit is less than this value, it will be ignored.
			...
			Settings.EmissiveIdleName = "Emissive"; //Emissive Material Name
			Settings.EmissiveIdleAmount = 1; //Emissive Amount - can be between 0-1 (non integers should be formatted with 'f' at the end. eg: 0.5f)
			Settings.EmissiveIdleColor = new Color(0,0,255,175); //RGBA value of Emissive
			
			//Emissives - Charging
			Settings.EmissiveChargingName = "Emissive"; //Emissive Material Name
			Settings.EmissiveChargingAmount = 1; //Emissive Amount - can be between 0-1 (non integers should be formatted with 'f' at the end. eg: 0.5f)
			Settings.EmissiveChargingColor = new Color(0,0,255,255); //RGBA value of Emissive
			
			//Emissives - Firing
			Settings.EmissiveFiringName = "Emissive"; //Emissive Material Name
			Settings.EmissiveFiringAmount = 1; //Emissive Amount - can be between 0-1 (non integers should be formatted with 'f' at the end. eg: 0.5f)
			Settings.EmissiveFiringColor = new Color(0,0,255,175); //RGBA value of Emissive when Firing
			Settings.EmissiveFiringOffColor = new Color(0,0,255,175); //RGBA value of Emissive when Not Firing
			
			//Multibeam Settings
			Settings.BarrelSubpartOffsets.Add(new Vector3D(0,0,0)); //Copy This Line and Provide the XYZ offset of any additional barrels that will fire beams on your weapons. Default offset of 0,0,0 can be changed if needed.
			...
			//Upgrade Valid Names
				...
				*/
				...
				//Base Damage
				Settings.UseBaseDamage = true; //Specifies if beam should deal regular damage.
				Settings.BaseDamageAmount = 1; //Damage amount per step (steps defined by DamageTimerLimit setting above)
				Settings.UsePenetrativeDamage = false; //If true, the beam will damage multiple blocks within a grid per step.
				Settings.PenetrativeDistance = 5; //Distance the penetrative damage can reach if enabled.
				Settings.RelaxedMissileIntercept = true; //If true, shots fired at lasers that come close to hitting will still register as a hit.
				...
				//Sound Settings
				Settings.FiringSoundId = "PDFire"; //You can specify an AudioDefinition subtype ID that will play when the weapon is fired.
				...
				Settings.BeamMinimumRadius = 2.1f; //Minimum Random Beam Radius if UseBeamFlicker is true
				Settings.BeamMaximumRadius = 2.5f; //Maximum Random Beam Radius if UseBeamFlicker is true
				Settings.BeamColors.Add(Color.Red);   //The color of the bolt. Copy this line to use other colors in the bolt.
				Settings.FadeThroughColors = false; //If true, beam color will not be randomized. The color will fade from one color to the next in the list you provide (requires at least 2 colors to use)
			...
			//Add Your Block SubtypeId below
			if(subtypeName == "PDLaserSmall"){
				
				//Do Not Edit This Line
				var Settings = new WeaponConfig();
				
				//Weapon Subtype
				Settings.WeaponSubtypeId = "PDLaserSmall"; //Change this to the same weapon subtype as used above in the script setup
				Settings.UseScriptedFire = true; //Change this to false if you only want to use the ammo generating feature of the weapon.
				//Incomplete Feature: Settings.RegisterDamageHandlerForTracers = false; //Set to true if you plan to use non-beam vanilla tracers with this weapon.
			...
			if(subtypeName == "HeavyLaserTurret"){
				
				//Do Not Edit This Line
				var Settings = new WeaponConfig();
				
				//Weapon Subtype
				Settings.WeaponSubtypeId = "HeavyLaserTurret"; //Change this to the same weapon subtype as used above in the script setup
				Settings.UseScriptedFire = true; //Change this to false if you only want to use the ammo generating feature of the weapon.
				//Incomplete Feature: Settings.RegisterDamageHandlerForTracers = false; //Set to true if you plan to use non-beam vanilla tracers with this weapon.
				...
				Settings.UseRegenerativeAmmo = true; //If set to 'true', then this weapon will consume grid energy and generate ammo automatically.
				Settings.AmmoMagazineSubtypeId = "PDLaserCharge"; //The AmmoMagazine SubtypeId this weapon uses.
				Settings.AmmoRegenerationMaxPowerDraw = 50; //Maximum amount of power the weapon should draw to generate ammo.
				Settings.AmmoRegenerationMedPowerDraw = 50; //If Maximum amount of power draw is unavailable, then this amount is drawn instead.
				Settings.AmmoRegenerationTime = 50; //Time until ammo is generated (at rate of 1MW per second).
				Settings.AmmoAmountToAdd = 20; //Number of ammo magazines added when a charge is complete.
				Settings.MaxAmmoInInventory = 20; //If ammo in weapon meets or exceeds this number, ammo regeneration will stop.
				Settings.AmmoRegenerationFreeForNPC = true; //If true and the block is owned by a valid NPC identity, the weapon will not draw energy to generate ammo, but will still create the ammo as if charging at AmmoRegenerationMaxPowerDraw rate.
				Settings.MustBeWorkingAtMaxDraw = false; //If true, weapon must be on, undamaged, and charging at max. If any of the consitions are not met, charge is reset to 0 and ammo is removed.
			...
			//Multibeam Settings
			Settings.BarrelSubpartOffsets.Add(new Vector3D(0,0.75f,-5));
			Settings.BarrelSubpartOffsets.Add(new Vector3D(0,-0.75f,-5)); //Copy This Line and Provide the XYZ offset of any additional barrels that will fire beams on your weapons. Default offset of 0,0,0 can be changed if needed.
			...
			//Add Your Block SubtypeId below
			if(subtypeName == "LightLaserTurretLarge"){
				
				//Do Not Edit This Line
				var Settings = new WeaponConfig();
				
				//Weapon Subtype
				Settings.WeaponSubtypeId = "LightLaserTurretLarge"; //Change this to the same weapon subtype as used above in the script setup
				Settings.UseScriptedFire = true; //Change this to false if you only want to use the ammo generating feature of the weapon.
				//Incomplete Feature: Settings.RegisterDamageHandlerForTracers = false; //Set to true if you plan to use non-beam vanilla tracers with this weapon.
			...
			//Multibeam Settings
			Settings.BarrelSubpartOffsets.Add(new Vector3D(0,0,-2.8f)); //Copy This Line and Provide the XYZ offset of any additional barrels that will fire beams on your weapons. Default offset of 0,0,0 can be changed if needed.
			...
			//Add Your Block SubtypeId below
			if(subtypeName == "LightLaserTurretSmall"){
				
				//Do Not Edit This Line
				var Settings = new WeaponConfig();
				
				//Weapon Subtype
				Settings.WeaponSubtypeId = "LightLaserTurretSmall"; //Change this to the same weapon subtype as used above in the script setup
				Settings.UseScriptedFire = true; //Change this to false if you only want to use the ammo generating feature of the weapon.
				//Incomplete Feature: Settings.RegisterDamageHandlerForTracers = false; //Set to true if you plan to use non-beam vanilla tracers with this weapon.
