...
using VRage.Utils;
using VRageMath;
using PO_CustomEnergyWeapons;

namespace PO_CustomEnergyWeapons.Config{
	
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_LargeGatlingTurret), true)]
	public class PO_GatlingTurretLogic : PO_WeaponLogic { }

	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_LargeMissileTurret), true, "HeavyLaserTurret","LightLaserTurretLarge","LightLaserTurretSmall","PDLaser","PDLaserSmall")]
	public class PO_LargeMissileTurretLogic : PO_WeaponLogic { }

	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_InteriorTurret), true)]
	public class PO_InteriorTurretLogic : PO_WeaponLogic { }
	
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_SmallGatlingGun), true)]
	public class PO_SmallGatlingGunLogic : PO_WeaponLogic { }
	
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_SmallMissileLauncher), true, "HeavyFixedLaser","LightFixedLaser")]
	public class PO_SmallMissileLauncherLogic : PO_WeaponLogic { }
	
	public class PO_WeaponLogic : MyGameLogicComponent{
