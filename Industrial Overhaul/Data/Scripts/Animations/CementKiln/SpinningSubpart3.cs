...
namespace CementKilnSpinAnimation3
{
    ...
    public class CementKilnSpin3 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixAxis = Matrix.CreateFromAxisAngle(Axis, -0.04f);
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(5.21434f, -1.05f, -0.504215f); // (x, y, z) offset from center of block
