...
namespace MunitionsFactorySlideAnimation1
{
    ...
    public class MunitionsFactorySlide1 : MyGameLogicComponent
    {
            ...
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    if(subpartFirstFind)
                    {
						...
						MatrixSlide = Matrix.CreateTranslation(1.5f, -0.635075f, 0.8f); // (x, y, z) offset from center of block
                    }
