...
namespace CoalFurnaceSpinAnimation1
{
    // Edit the block type and subtypes to match your block.
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_OxygenGenerator), false, "CoalFurnace")]
    public class CoalFurnaceSpin1 : MyGameLogicComponent
    {
