...
namespace AutoLoomSpinAnimation2
{
    ...
    public class AutoLoomSpin2 : MyGameLogicComponent
    {
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(-1.35f, -1.275f, 0f); // (x, y, z) offset from center of block
