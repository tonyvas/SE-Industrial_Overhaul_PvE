...
namespace AutoLoomSpinAnimation7
{
    ...
    public class AutoLoomSpin7 : MyGameLogicComponent
    {
        ...
        private int SpinTime = 60; // If using reversing rotation, how long the subpart spins before reversing, in ticks
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixX = Matrix.CreateRotationX(0.1f); // rotation speed for each axis
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(-0.75f, -1.86478f, 3.0f); // (x, y, z) offset from center of block
