...
namespace AutoLoomSpinAnimation5
{
    ...
    public class AutoLoomSpin5 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixZ = Matrix.CreateRotationZ(-0.015f);
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(-3.74838f, -1.09187f, 0f); // (x, y, z) offset from center of block
