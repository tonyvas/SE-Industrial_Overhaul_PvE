...
namespace AutoLoomSlideAnimation1
{
    ...
    public class AutoLoomSlide1 : MyGameLogicComponent
    {
            ...
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    if(subpartFirstFind)
                    {
						...
						MatrixSlide = Matrix.CreateTranslation(0.25f, 0.15f, 0f); // (x, y, z) offset from center of block
                    }
