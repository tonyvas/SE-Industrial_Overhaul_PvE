...
namespace AutoLoomSpinAnimation4
{
    ...
    public class AutoLoomSpin4 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixZ = Matrix.CreateRotationZ(-0.065f);
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(-2.24839f, -1.6153f, 0f); // (x, y, z) offset from center of block
