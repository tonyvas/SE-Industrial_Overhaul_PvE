...
namespace SiliconFuserSpinAnimation2
{
    ...
    public class SiliconFuserSpin2 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixY = Matrix.CreateRotationY(0.05f);
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(-1.5f, 0.745012f, -1.0f); // (x, y, z) offset from center of block
