...
namespace ReprocessorSpinAnimation1
{
    ...
    public class ReprocessorSpin1 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixZ = Matrix.CreateRotationZ(0.15f);
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(-2.49809f, -1.69432f, 0.632325f); // (x, y, z) offset from center of block
