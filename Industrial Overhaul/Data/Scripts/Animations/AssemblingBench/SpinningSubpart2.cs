...
namespace BasicAssemblerSpinAnimation2
{
    ...
    public class BasicAssemblerSpin2 : MyGameLogicComponent
    {
        ...
        private int SpinTime = 70; // If using reversing rotation, how long the subpart spins before reversing, in ticks
		
        private int SpinReverseTime = 70; // How long the subpart spins in reverse, in ticks
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(0.352453f, 0.468945f, -0.25f); // (x, y, z) offset from center of block
