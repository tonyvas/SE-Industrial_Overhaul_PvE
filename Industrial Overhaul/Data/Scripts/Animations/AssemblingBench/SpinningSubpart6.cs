...
namespace BasicAssemblerSpinAnimation6
{
    ...
    public class BasicAssemblerSpin6 : MyGameLogicComponent
    {
        private const string SUBPART_NAME = "Spin6"; // dummy name without the "subpart_" prefix
        ...
        private int SpinTime = 75; // If using reversing rotation, how long the subpart spins before reversing, in ticks
		
        private int SpinReverseTime = 75; // How long the subpart spins in reverse, in ticks
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(0.352453f, 0.468945f, 0.15f); // (x, y, z) offset from center of block
