...
namespace BasicAssemblerSpinAnimation3
{
    ...
    public class BasicAssemblerSpin3 : MyGameLogicComponent
    {
        ...
        private int SpinTime = 50; // If using reversing rotation, how long the subpart spins before reversing, in ticks
		
        private int SpinReverseTime = 50; // How long the subpart spins in reverse, in ticks
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(0.946924f, 0.468945f, -0.15f); // (x, y, z) offset from center of block
