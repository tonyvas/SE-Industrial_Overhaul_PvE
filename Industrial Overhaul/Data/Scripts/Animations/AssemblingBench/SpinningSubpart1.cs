...
namespace BasicAssemblerSpinAnimation1
{
    ...
    public class BasicAssemblerSpin1 : MyGameLogicComponent
    {
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(0.946924f, 0.468945f, -0.35f); // (x, y, z) offset from center of block
