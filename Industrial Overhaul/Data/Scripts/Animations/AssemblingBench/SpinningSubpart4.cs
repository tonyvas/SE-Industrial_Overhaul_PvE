...
namespace BasicAssemblerSpinAnimation4
{
    ...
    public class BasicAssemblerSpin4 : MyGameLogicComponent
    {
        ...
        private int SpinTime = 65; // If using reversing rotation, how long the subpart spins before reversing, in ticks
		
        private int SpinReverseTime = 65; // How long the subpart spins in reverse, in ticks
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(0.352453f, 0.468945f, -0.05f); // (x, y, z) offset from center of block
