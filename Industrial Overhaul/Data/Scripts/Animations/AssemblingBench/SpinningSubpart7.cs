...
namespace BasicAssemblerSpinAnimation7
{
    ...
    public class BasicAssemblerSpin7 : MyGameLogicComponent
    {
        private const string SUBPART_NAME = "Spin7"; // dummy name without the "subpart_" prefix
        ...
        private int SpinTime = 80; // If using reversing rotation, how long the subpart spins before reversing, in ticks
		
        private int SpinReverseTime = 80; // How long the subpart spins in reverse, in ticks
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(0.946924f, 0.468945f, 0.25f); // (x, y, z) offset from center of block
