...
namespace MicroelectronicsFactorySpinAnimation1
{
    ...
    public class MicroelectronicsFactorySpin1 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixY = Matrix.CreateRotationY(0.0075f);
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(1.1658f, -0.158f, 0f); // (x, y, z) offset from center of block
