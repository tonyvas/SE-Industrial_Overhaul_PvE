...
namespace BitumenExtractorSpinAnimation1
{
    // Edit the block type and subtypes to match your block.
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Refinery), false, "BitumenExtractor")]
    public class BitumenExtractorSpin1 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixX = Matrix.CreateRotationX(0.05f); // rotation speed for each axis
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(0f, -2.5f, -2.63695f); // (x, y, z) offset from center of block
