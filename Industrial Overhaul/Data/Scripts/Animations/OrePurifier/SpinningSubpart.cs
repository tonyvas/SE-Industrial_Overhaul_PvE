...
namespace OrePurifierSpinAnimation1
{
    // Edit the block type and subtypes to match your block.
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Refinery), false, "OrePurifier")]
    public class OrePurifierSpin1 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixYReverse = Matrix.CreateRotationY(-0.025f); // in most cases should be the exact negative of the normal rotation
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(-0.924114f, 0f, 0f); // (x, y, z) offset from center of block
