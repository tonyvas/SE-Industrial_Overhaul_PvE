...
namespace AdvancedAssemblerSpinAnimation2
{
    ...
    public class AdvancedAssemblerSpin2 : MyGameLogicComponent
    {
        ...
        private int SpinTime = 180; // How long the subpart spins before reversing, in ticks
		
        private int SpinReverseTime = 180; // How long the subpart spins in reverse, in ticks
