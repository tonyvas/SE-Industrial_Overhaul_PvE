...
namespace AdvancedAssemblerSpinAnimation3
{
    ...
    public class AdvancedAssemblerSpin3 : MyGameLogicComponent
    {
        ...
        private int SpinTime = 210; // How long the subpart spins before reversing, in ticks
		
        private int SpinReverseTime = 210; // How long the subpart spins in reverse, in ticks
