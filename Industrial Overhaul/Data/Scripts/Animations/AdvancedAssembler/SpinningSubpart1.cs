...
namespace AdvancedAssemblerSpinAnimation1
{
    ...
    public class AdvancedAssemblerSpin1 : MyGameLogicComponent
    {
        ...
        private int SpinTime = 200; // How long the subpart spins before reversing, in ticks
		
        private int SpinReverseTime = 200; // How long the subpart spins in reverse, in ticks
