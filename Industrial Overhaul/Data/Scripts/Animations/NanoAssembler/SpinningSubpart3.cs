...
namespace NanoAssemblerSpinAnimation3
{
    ...
    public class NanoAssemblerSpin3 : MyGameLogicComponent
    {
        ...
        private int SpinTime = 500; // How long the subpart spins before reversing, in ticks
		
        private int SpinReverseTime = 500; // How long the subpart spins in reverse, in ticks
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixY = Matrix.CreateRotationY(0.0027f);
            MatrixZ = Matrix.CreateRotationZ(0f);

            MatrixXReverse = Matrix.CreateRotationX(0f); // reverse rotation speed for each axis
            MatrixYReverse = Matrix.CreateRotationY(-0.0027f); // in most cases should be the exact negative of the normal rotation
