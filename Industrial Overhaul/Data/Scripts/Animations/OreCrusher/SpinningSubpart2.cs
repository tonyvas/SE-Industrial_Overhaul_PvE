...
namespace OreCrusherSpinAnimation2
{
    // Edit the block type and subtypes to match your block.
    [MyEntityComponentDescriptor(typeof(MyObjectBuilder_Refinery), false, "RockCrusher")]
    public class OreCrusherSpin2 : MyGameLogicComponent
    {
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(0f, -4.05843f, 2.02514f); // (x, y, z) offset from center of block
