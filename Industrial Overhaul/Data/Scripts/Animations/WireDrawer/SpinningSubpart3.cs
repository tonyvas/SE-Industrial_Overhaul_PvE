...
namespace WireDrawerSpinAnimation3
{
    ...
    public class WireDrawerSpin3 : MyGameLogicComponent
    {
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(0.623939f, -0.319505f, 0.19781f); // (x, y, z) offset from center of block
