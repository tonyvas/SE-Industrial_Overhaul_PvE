...
namespace WireDrawerSpinAnimation1
{
    ...
    public class WireDrawerSpin1 : MyGameLogicComponent
    {
        ...
        public override void UpdateOnceBeforeFrame()
        {
            ...
            MatrixY = Matrix.CreateRotationY(-0.02f);
        ...
        public override void UpdateBeforeSimulation()
        {
            try
            {
                ...
                if(Entity.TryGetSubpart(SUBPART_NAME, out subpart))
                {
                    ...
                    if(shouldSpin)
					{		
						var offset = new Vector3(-0.282471f, -0.072698f, -0.181524f); // (x, y, z) offset from center of block
